...
class TestUi(unittest.TestCase):
    ...
    def test_add_blogpostvinkki_calls_add_blogpost_vinkki_to_db(self):
        self.io = Stub_io(["2", "4", "Blogikirjoittaja", "Tietokoneohje", "Miten tietokone sammutetaan", "Ohje ammattilaisille", "2", "2", "5"])
        self.stub_ui = Ui(self.io, self.db_mock, self.number_generator_mock)
        self.stub_ui.start()
    ...
    def test_adding_tags_to_kirjavinkki_calls_add_tag_to_vinkki(self):
        self.io = Stub_io(["2", "1", "Book person", "Tagikirja", "321654", "tags are cool", "1", "this is a tag", "2", "2", "5"])
        self.stub_ui = Ui(self.io, self.db_mock, self.number_generator_mock)
        self.stub_ui.start()
    ...
    def test_adding_tags_to_podcastvinkki_calls_add_tag_to_podcastvinkki(self):
        self.io = Stub_io([
            ...
            "Why tags are nice",
            "Very useful info", "1", "this is a tag too", "2", "2", "5"
        ])
        self.stub_ui = Ui(self.io, self.db_mock, self.number_generator_mock)
        self.stub_ui.start()
    ...
    def test_adding_tags_to_blogpostvinkki_calls_add_tag_to_blogpostvinkki(self):
        self.io = Stub_io(["2", "4", "Blog person", "importance of tags", "significance of tags", "best tags to use", "1", "this too is a tag", "2", "2", "5"])
        self.stub_ui = Ui(self.io, self.db_mock, self.number_generator_mock)
        self.stub_ui.start()
