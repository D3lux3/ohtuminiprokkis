...
class TestUi(unittest.TestCase):
    ...
    def test_adding_courses_to_podcastvinkki_calls_add_course_to_podcastvinkki(self):
        self.io = Stub_io([
    ...
    def test_adding_courses_to_blogpostvinkki_calls_add_course_to_blogpostvinkki(self):
        self.io = Stub_io(["2", "4", "Blog creator", "important courses", "best courses", "fun courses to take", "blogsite.com", "2", "1", "LaMa", "2", "0"])
        self.stub_ui = Ui(self.io, self.db_mock, self.number_generator_mock)
        self.stub_ui.start()
